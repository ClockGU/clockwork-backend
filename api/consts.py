...
# Notification Limitations and Check Constraints
STUDENT_NOTIFICATION_INTERVAL=5
STUDENT_NOTIFCATION=4

SUPERVISOR_NOTIFICATION_INTERVAL=4
SUPERVISOR_NOTIFICATION=3

APPROVER_NOTIFICATION_INTERVAL=5
APPROVER_NOTIFICATION=6