...
def get_supervisor_petition_update_model(petition: Petition = Depends(get_specified_petition), body:dict, db: Session = Depends(get_db)) -> PetitionSupervisorUpdate:
    """
...
def get_clerk_petition_update_model(petition: Petition = Depends(get_specified_petition), body:dict, db: Session = Depends(get_db)) -> PetitionClerkUpdate:
    """
    Returns a PetitionSupervisorUpdate model instance with the provided petition_id and body.
    """
