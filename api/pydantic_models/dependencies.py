...
from api.pydantic_models import PetitionSupervisorUpdate, PetitionClerkUpdate, PetitionStudentUpdate
...
def get_student_petition_update_model(body:dict, petition: Petition = Depends(get_specified_petition), db: Session = Depends(get_db)) -> PetitionStudentUpdate:
    """
    Returns a PetitionSupervisorUpdate model instance with the provided petition_id and body.
    """
