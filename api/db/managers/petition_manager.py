...
class PetitionManager:
    ...
    def get_student_petitions(self, student_user_name: str) -> List[Petition]:
        ...
        statement = select(self.schema).where(
            (self.schema.student_user_name == student_user_name) & 
            (
    ...
    def get_student_approved_petitions_in_semester(self, student_user_name: str, start_date: date) -> List[Petition]:
        ...
        # Query petitions with student username, approved status, and within semester date range
        statement = select(self.schema).where(
            (self.schema.student_user_name == student_user_name) &
